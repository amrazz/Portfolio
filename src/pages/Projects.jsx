...
const getTagIcon = (tag) => {
  ...
  if (tagLower.includes("react") || tagLower.includes("jsx"))
    return <Code className="w-3 h-3" />;
  if (
    tagLower.includes("django") ||
    tagLower.includes("drf") ||
    tagLower.includes("python") ||
    tagLower.includes("fastapi")
  )
    return <Database className="w-3 h-3" />;
  if (
    tagLower.includes("css") ||
    tagLower.includes("tailwind") ||
    tagLower.includes("shad cn") ||
    tagLower.includes("framer motion")
  )
    return <Palette className="w-3 h-3" />;
  if (tagLower.includes("html") || tagLower.includes("js"))
    return <Globe className="w-3 h-3" />;
  if (tagLower.includes("postgres") || tagLower.includes("mongodb"))
    return <Database className="w-3 h-3" />;
  if (tagLower.includes("firebase") || tagLower.includes("google auth"))
    return <Globe className="w-3 h-3" />;
  if (
    tagLower.includes("gemini") ||
    tagLower.includes("editor js") ||
    tagLower.includes("react toastify")
  )
    return <Code className="w-3 h-3" />;
...
const getTagColor = (tag) => {
  ...
  if (tagLower.includes("postgres"))
    return "bg-indigo-500/10 text-indigo-400 border-indigo-500/20";
  if (tagLower.includes("mongodb"))
    return "bg-emerald-500/10 text-emerald-400 border-emerald-500/20";
  if (tagLower.includes("tailwind") || tagLower.includes("shad cn"))
    return "bg-cyan-500/10 text-cyan-400 border-cyan-500/20";
  if (tagLower.includes("framer motion"))
    return "bg-pink-500/10 text-pink-400 border-pink-500/20";
  if (tagLower.includes("firebase"))
    return "bg-orange-500/10 text-orange-400 border-orange-500/20";
  if (tagLower.includes("html") || tagLower.includes("js"))
    return "bg-yellow-500/10 text-yellow-400 border-yellow-500/20";
  if (tagLower.includes("google auth"))
    return "bg-red-500/10 text-red-400 border-red-500/20";
  if (tagLower.includes("gemini"))
    return "bg-purple-500/10 text-purple-400 border-purple-500/20";
  if (tagLower.includes("editor js"))
    return "bg-fuchsia-500/10 text-fuchsia-400 border-fuchsia-500/20";
  if (tagLower.includes("react toastify"))
    ...
    >
      <div className="max-w-7xl mx-4 md:mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            Discover my latest work showcasing full-stack development with
            Django, DRF, React, and modern web technologies
          </p>
